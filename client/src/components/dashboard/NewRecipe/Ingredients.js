...
import { Grid, Typography, TextField, MenuItem, IconButton, Button } from '@material-ui/core';
                    ...
                    return (
                        ...
                        <Grid item xs={11} sm={11} md={2} lg={2} xl={2}>
                            <TextField
                                ...
                                onChange={(e) => handleOnChange(INGREDIENT_AMOUNT, {index, value: isNaN(e.target.value) ? 0 : parseInt(e.target.value)})}
                                InputLabelProps={{
                                    shrink: true,
                                }}
                            />
                        ...
                        <Grid item xs={11} sm={11} md={2} lg={2} xl={2}>
                            <TextField
                                ...
                                onChange={(e) => {handleOnChange(INGREDIENT_UNIT, {index, value: e.target.value})}}
                                size="small"
                                fullWidth={true}
                                InputLabelProps={{
                                    shrink: true,
                                ...
                                >
                                {measures.map((option) => (
                                    <MenuItem id={index} key={option.value} value={option.value}>
                                    {option.label}
                                    </MenuItem>
                                ))}
                            </TextField>
                        ...
                        <TextField
                            ...
                            required
                            fullWidth={true}
                            onChange={(e) => {handleOnChange(INGREDIENT_NAME, {index, value: e.target.value});
                                              handleOnChange(INGREDIENTS, {index, value: e.target.value })}}
                            variant="outlined"
                            InputLabelProps={{
                                shrink: true,
                            }}
                        ...
                        <Grid item xs={11} sm={11} md={1} lg={1} xl={1}>
                            <IconButton onClick={() => RemoveInputField(index, EXTENDED_INGREDIENTS)}>
                                <HighlightOffIcon />
                            </IconButton>
                        </Grid>
                </Grid>
